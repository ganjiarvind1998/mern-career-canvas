...
//   try {
//     const { applicantName, companyName, jobTitle, skills, achievements } = req.body;
...
//     const prompt = `Write a professional cover letter for ${applicantName} applying for the ${jobTitle} position at ${companyName}.

// Applicant Skills: ${skills || 'Not specified'}
...
// 5. Tailor the content specifically to the ${jobTitle} role`;
...
// Education:
// ${formattedEducation || 'Not specified'}

// Experience:
// ${formattedExperience || 'Not specified'}

// Skills:
// ${formattedSkills || 'Not specified'}

// The resume should include clear sections and be properly formatted.`;
